...
import ObjInterface from '../../../Domain/Entities/ProposalState/Interface'
import Serviceable from '../../../Domain/Entities/ProposalState/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/proposalState'
	...
	@inject(TYPES.Validable) @named(TYPES.ProposalState) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.ProposalState) private schema: Schemable
	@inject(TYPES.ProposalStateServiceableDomain) private service: Serviceable
