...
import ObjInterface from '../../../Domain/Entities/Post/Interface'
import Serviceable from '../../../Domain/Entities/Post/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Post) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Post) private schema: Schemable
	@inject(TYPES.PostServiceableDomain) private service: Serviceable
