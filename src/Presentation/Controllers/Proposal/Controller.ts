...
import ObjInterface from '../../../Domain/Entities/Proposal/Interface'
import Serviceable from '../../../Domain/Entities/Proposal/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/proposal'
	...
	@inject(TYPES.Validable) @named(TYPES.Proposal) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Proposal) private schema: Schemable
	@inject(TYPES.ProposalServiceableDomain) private service: Serviceable
