...
import ObjInterface from '../../../Domain/Entities/Category/Interface'
import Serviceable from '../../../Domain/Entities/Category/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Category) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Category) private schema: Schemable
	@inject(TYPES.CategoryServiceableDomain) private service: Serviceable
