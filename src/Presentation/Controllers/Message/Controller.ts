...
import ObjInterface from '../../../Domain/Entities/Message/Interface'
import Serviceable from '../../../Domain/Entities/Message/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Message) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Message) private schema: Schemable
	@inject(TYPES.MessageServiceableDomain) private service: Serviceable
