...
import ObjInterface from '../../../Domain/Entities/Subcategory/Interface'
import Serviceable from '../../../Domain/Entities/Subcategory/Ports/Serviceable'

@injectable()
export default class Controller implements Routeable, Patheable {

	public router: Router = container.get<Router>(TYPES.Router)
	public path: string = '/subcategory'
	...
	@inject(TYPES.Validable) @named(TYPES.Subcategory) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Subcategory) private schema: Schemable
	@inject(TYPES.SubcategoryServiceableDomain) private service: Serviceable
