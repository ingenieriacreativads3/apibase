...
import ObjInterface from '../../../Domain/Entities/Transaction/Interface'
import Serviceable from '../../../Domain/Entities/Transaction/Ports/Serviceable'
...
export default class Controller implements Routeable, Patheable {
	...
	@inject(TYPES.Validable) @named(TYPES.Transaction) private dto: Validable
	@inject(TYPES.Schemable) @named(TYPES.Transaction) private schema: Schemable
	@inject(TYPES.TransactionServiceableDomain) private service: Serviceable
